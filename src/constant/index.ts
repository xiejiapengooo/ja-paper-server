...
export const PAPER_QUESTION_TYPE_WEIGHT = {
  N1: {
    [PAPER_QUESTION_TYPE.CHINESE_PRONUNCIATION]: 1,
    [PAPER_QUESTION_TYPE.CONTEXT]: 1,
    [PAPER_QUESTION_TYPE.SYNONYM_SUBSTITUTION]: 1,
    [PAPER_QUESTION_TYPE.USAGE]: 2,
    [PAPER_QUESTION_TYPE.SENTENCE_GRAMMAR_1]: 1,
    [PAPER_QUESTION_TYPE.SENTENCE_GRAMMAR_2]: 1,
    [PAPER_QUESTION_TYPE.ARTICLE_GRAMMAR]: 2,
    [PAPER_QUESTION_TYPE.CONTENT_COMPREHENSION_SHORT]: 2,
    [PAPER_QUESTION_TYPE.CONTENT_COMPREHENSION_MIDDLE]: 2,
    [PAPER_QUESTION_TYPE.CONTENT_COMPREHENSION_LONG]: 3,
    [PAPER_QUESTION_TYPE.SYNTHETICAL_COMPREHENSION_READ]: 2,
    [PAPER_QUESTION_TYPE.THESIS_COMPREHENSION]: 3,
    [PAPER_QUESTION_TYPE.INFORMATION_RETRIEVAL]: 2,
    [PAPER_QUESTION_TYPE.QUESTION_COMPREHENSION]: 2,
    [PAPER_QUESTION_TYPE.EMPHASIS_COMPREHENSION]: 1,
    [PAPER_QUESTION_TYPE.OUTLINE_COMPREHENSION]: 2,
    [PAPER_QUESTION_TYPE.INSTANT_RESPONSE]: 1,
    [PAPER_QUESTION_TYPE.SYNTHETICAL_COMPREHENSION_LISTEN]: 3,
  },
}
